...
class PlatformComparison:
    ...
    def run_comparison(self):
        ...
        print(f"Height range: {self.config.min_height*1000:.0f}mm - {self.config.max_height*1000:.0f}mm")
    ...
    def _print_summary(self, results):
        ...
        stewart_avg_stroke = np.mean([r['stroke_range'] for r in results['stewart_3dof'] if r['valid']])
    ...
    def _plot_comparison(self, results):
        ...
        ax.axhline(y=self.config.max_height * 1000, color='r', linestyle='--', 
                   label='Max Limit', alpha=0.7)
        ax.set_xlabel('Test Configuration')
        ...
        ax.boxplot([tripod_all_lengths, stewart_all_lengths],
        ...
        line = ax2.plot(configs, performance, 'ro-', linewidth=2, 
                       markersize=10, label='Performance')
